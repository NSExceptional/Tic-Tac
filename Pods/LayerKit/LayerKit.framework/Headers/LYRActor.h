...
@property (nonatomic, readonly, nullable) NSString *userID LYR_QUERYABLE_FROM(LYRMessage) LYR_QUERYABLE_FROM(LYRConversation);;
...
@property (nonatomic, readonly, nullable) NSString *name LYR_QUERYABLE_FROM(LYRMessage) LYR_QUERYABLE_FROM(LYRConversation);;
