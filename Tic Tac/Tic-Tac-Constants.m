...
NSString * const kPref_unusedUserIdentifier     = @"unused_user";
NSString * const kPref_handlesToUserIdentifiers = @"handles_to_uids";
...
NSString * const kPref_showBlockedContent       = @"show_blocked_content";
...
BOOL YYContainsThirst(NSString *string) {
    if ([string containsString:@"horny"] || [string containsString:@"sex"] || [string containsString:@"get laid"] ||
        [string containsString:@"cuddle"] || [string matchGroupAtIndex:0 forRegex:@"(to|wanna|want to|good) fuck"]) {
        return YES;
    }
